...
def main():
    """主函数，用于支持多进程"""
    # 配置参数
    USE_CONCURRENT = True  # 设置为True使用并发模式，False使用原始串行模式
    MAX_IMAGES = 2000
    MAX_WORKERS = None  # None表示自动选择，也可以手动设置如4
    ...
    # 设置路径和模态
    images_dir = r"E:\Project\SpaceClone\label\Brain"
    modality = "Brain"
    output_dir = r"E:\Project\SpaceClone\synthesisLabel\BrainDSA"
